...
public class FeedDAO {
    ...
    private static final String StatusHandleAttr = "status_handle";
    ...
    public void addToFeed(String handle, String time, String content, String status_handle, String name, String image_url) {
        ...
        Item item = new Item()
                ...
                .with(StatusHandleAttr, status_handle)
                .with(NameAttr, name)
    ...
    public StatusResponse getFeed(StatusRequest request) {
        ...
        if (items != null) {
            for (Map<String, AttributeValue> item : items){
                ...
                String statusHandle = item.get(StatusHandleAttr).getS();
                String name = item.get(NameAttr).getS();
                String image = item.get(ImageAttr).getS();
                statuses.add(getStatus(name,image,statusHandle,content,timestamp));
            }
        }
