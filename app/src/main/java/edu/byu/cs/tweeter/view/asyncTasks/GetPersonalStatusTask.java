...
public class GetPersonalStatusTask extends AsyncTask<StatusRequest, Void, StatusResponse> {
    private final StatusPresenter presenter;
    private final GetPersonalStatusObserver observer;

    public interface GetPersonalStatusObserver {
        void statusesRetrieved(StatusResponse followingResponse);
    }

    public GetPersonalStatusTask(StatusPresenter presenter, GetPersonalStatusObserver observer) {
